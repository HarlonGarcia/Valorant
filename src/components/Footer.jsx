...
const Footer = () => {
  return (
    <footer className="flex justify-center absolute z-40 bottom-0 items-center w-full p-8 bg-blue sm:px-16 lg:px-32">
      <ul className="text-white/90 text-sm font-montserrat sm:flex sm:justify-end md:text-md">
        <li className="flex items-center mb-4 sm:mb-0 sm:mr-4">
          This website is a non-official API and not endorsed by Riot Games in
